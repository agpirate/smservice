...
export default {
  ...
  methods: {
    async fetchData() {
      ...
      const response1 = await axios.get('http://192.168.7.5:3000/client/clients');
      const response2 = await axios.get('http://192.168.7.5:3000/question/questions');
      const response3 = await axios.get('http://192.168.7.5:3000/feedback/feedbacks');
      const response4 = await axios.get('http://192.168.7.5:3000/pie/analysis')
