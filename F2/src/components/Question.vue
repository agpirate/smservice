<template>
  <div>
    ...
    <button @click="openCreateDialog" class="create-button">Create New Question</button>
...
export default {
  ...
  this.$refs.confirmationDialog.close();
    ...
    //  const response = await axios.post('http://localhost:8000/poll',poll); // Fetch data from JSON file
      await axios.put('http://localhost:3000/question/questions',poll); // Fetch data from JSON file
    ...
    //  const response = await axios.post('http://localhost:8000/poll',poll); // Fetch data from JSON file
     const response = await axios.post('http://localhost:3000/question/questions',poll); // Fetch data from JSON file
    ...
    async fetchPolls() {
      try {
        ...
        // const response = await axios.get('http://localhost:8000/poll', {
          const response = await axios.get('http://localhost:3000/question/questions', {
